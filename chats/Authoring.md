...
6. Prefer the local agent bridge when available; otherwise use structured document actions, project-file APIs, browser preview evidence, and validation output over hidden UI assumptions.
