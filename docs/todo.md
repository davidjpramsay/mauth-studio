...
- More high-level native tools:
  - Add compact teacher-task tools so the assistant does not hand-build huge action JSON: repair diagram by id, write all solutions, adjust response spaces, run layout/print checks, convert one source page/question, and apply exam front matter.
