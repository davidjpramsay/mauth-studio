...
- Assistant-facing `graph2d` guidance now exposes `graphConfig.data.geometry2d` for source-faithful 2D geometry sketches, and preview summaries report geometry point/segment/angle/decoration counts so semantic review can inspect these diagrams without another paid vision pass.
