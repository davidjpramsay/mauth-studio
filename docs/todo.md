...
- Add renderer-level diagram inspection and repair after payload validation: label collision checks, graph extent checks, visual screenshot/metadata inspection, Penrose render-failure repair, Plotly/JSXGraph output checks, and print/output fit checks.
