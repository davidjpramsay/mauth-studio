...
test("macOS package registers the canonical document type and Quick Look preview", () => {
  ...
  assert.deepEqual(declaration.UTTypeConformsTo, ["public.data"]);
...
test("Quick Look manifest supports the exact exported document type", () => {
  const manifests = [["Preview", "com.apple.quicklook.preview"]];
