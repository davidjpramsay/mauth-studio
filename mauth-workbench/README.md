...
This folder is for local Codex work products and other external/local AI scratch files that should not live in the Mauth Studio app repo. It is safe to recreate locally and is intentionally separate from the app source tree.
...
If you only cloned `math-app/`, create a sibling `mauth-workbench/` folder next to it or point your local agent scratch path somewhere outside the app tree.
