          ...
          <section className="grid grid-cols-1 gap-3 border-t pt-3 md:grid-cols-[repeat(3,minmax(0,1fr))_auto] md:items-end">
            <label className="flex flex-col gap-2 text-xs font-medium">
              ...
              <NumericExpressionInput
                step={1}
                value={view.az}
                ariaLabel="3D view azimuth"
                onValueChange={(value) => updateView({ az: value ?? DEFAULT_3D_VIEW_STATE.az })}
                className="h-9 rounded-md border border-input bg-background px-2 text-sm font-normal"
              />
            </label>
            <label className="flex flex-col gap-2 text-xs font-medium">
              ...
              <NumericExpressionInput
                step={1}
                value={view.el}
                ariaLabel="3D view elevation"
                onValueChange={(value) => updateView({ el: value ?? DEFAULT_3D_VIEW_STATE.el })}
                className="h-9 rounded-md border border-input bg-background px-2 text-sm font-normal"
              />
            </label>
            <label className="flex flex-col gap-2 text-xs font-medium">
              ...
              <NumericExpressionInput
                step={1}
                value={view.bank}
                ariaLabel="3D view bank"
                onValueChange={(value) => updateView({ bank: value ?? DEFAULT_3D_VIEW_STATE.bank })}
                className="h-9 rounded-md border border-input bg-background px-2 text-sm font-normal"
              />
            </label>
