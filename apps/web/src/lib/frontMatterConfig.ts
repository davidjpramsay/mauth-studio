...
export const DEFAULT_EXAM_TITLE_PAGE: ExamTitlePageConfig = {
  ...
  documentCode: "",
  authorityName: "",
  examHeading: "Semester One Examination, 2026",
  bookletTitle: "Examination booklet",
  candidateLabelText: "",
  ...
  supervisorMaterials: "Examination booklet\nFormula sheet",
  ...
  specialItems: "nil",
  importantNoteTitle: "Before you begin",
  importantNoteBody: "Check that this booklet is complete. Place any unauthorised materials away and do not begin until instructed.",
  referenceText: "",
  bookletCode: "",
  courseHeader: "MATHEMATICAL METHODS",
  ...
  instructionsBody:
    "1. Write all answers in the spaces provided.\n\n2. Read each question carefully and follow any instructions specific to that question.\n\n3. Show all working clearly and use appropriate mathematical notation. Answers without supporting reasoning may not receive full marks.\n\n4. Cross out any work that you do not want marked.\n\n5. Pencil may be used for diagrams.\n\n6. If you continue an answer on a supplementary page, record the question number clearly and indicate where the answer continues.\n\n7. Leave the formula sheet with the examination booklet at the end of the session.",
...
export const DEFAULT_EXAM_FRONT_MATTER: FrontMatterConfig = {
  ...
  assessmentTitle: "Semester One Examination, 2026",
...
export const EXAM_SECTION_PRESETS: Array<{
  ...
  },
  {
    ...
    specialItems:
      "drawing instruments, templates, notes on one unfolded sheet of A4 paper,\nand up to three calculators, including scientific, graphics, or Computer\nAlgebra System (CAS) calculators",
