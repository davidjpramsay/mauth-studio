    ...
    if asks_to_write_question:
        ...
        if has_source_attachment and any(term in text for term in ("slope field", "direction field", "dy/dx")):
            diagram_guidance += (
                ...
                "and highlightedPoints for any requested point slope. Put solution curves in graphConfig.functions."
            )
        ...
        "properties": {
            ...
            "graphConfig": {
                ...
                "description": (
                    ...
                    "For graph2d slope fields, use data.slopeField:{expression,xValues?,yValues?,xRange?,yRange?,xStep?,yStep?,highlightedPoints?}. "
...
def mauth_convert_source_question_tool_definition(*, require_diagram: bool = False) -> dict[str, Any]:
    ...
    definition["description"] = (
        ...
        "graphs should use graph2d with data.slopeField plus graph2d.functions for any solution curve."
    )
    return definition
...
def mauth_author_add_diagram_tool_definition() -> dict[str, Any]:
    return {
        ...
        "description": (
            ...
            "For slope fields, use graph2d.data.slopeField rather than prose or loose line segments."
        ),
        "parameters": {
            "type": "object",
            "properties": {
...
- For slope-field/direction-field source diagrams, use graphConfig.type graph2d with data.slopeField rather than a bitmap, prose fallback, or many unrelated line_segment features. Include the differential expression and grid values/ranges, and encode requested point slopes in highlightedPoints.
