        ...
        "properties": {
            ...
            "graphConfig": {
                ...
                "description": (
                    ...
                    "When part text names an angle at a midpoint, include the actual two angle rays as segments; "
                    "for \\angle DMF with M on EF, include DM and MF, not only the whole FE edge. "
                ...
                "properties": {
                    ...
                    "data": {
                        ...
                        "description": (
                            ...
                            "faces:[{points:[...]}], and solids:[{kind:'cone'|'cylinder'|'sphere'|'circle'|'sphereCap',...}]; "
...
def source_conversion_renderer_guide(diagram_types: list[str] | None) -> str:
    ...
    guides = {
        ...
        "statsChart": (
            ...
            "columns with visible counts, use manualFrequencies with xValues and frequencies."
        ),
        "graph3d": (
